...
#define TLD7002_OTP_CUST_REG8											0x0A7U						/**< OPT CUSTOMER register 8 */
#define TLD7002_OTP_CUST_REG9											0x0A8U						/**< OPT CUSTOMER register 9 */
#define TLD7002_OTP_CUST_REG10											0x0A9U						/**< OPT CUSTOMER register 10 */
#define TLD7002_OTP_CUST_REG11											0x0AAU						/**< OPT CUSTOMER register 11 (general purpose) */
...
#define TLD7002_DTS_STAT_DTS_TEMP_MSK							  		  0x3FF0U					/*!< [4..13] Device temperature. */
...
/* TLD7002_OTP_CUST_REG8 register */
/** TLD7002_OTP_CUST_REG8
 *
 */
typedef struct {
...
} TLD7002_OTP_CUST_REG8_t;

/** TLD7002_OTP_CUST_REG8 positions */
#define TLD7002_OTP_CUST_REG8_CH_TH_DER_EN_POS							      0U					/*!< [0] Thermal derating Enable */
#define TLD7002_OTP_CUST_REG8_CH_TH_DER_TH_POS							      1U					/*!< [1..3] Thermal derating TJDER configuration */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_CH_SET_POS				   		  4U					/*!< [4..7] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH01_SET_POS				      8U					/*!< [8..9] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH23_SET_POS				     10U					/*!< [10..11] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH89_SET_POS				     12U					/*!< [12..13] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH1011_SET_POS			     14U					/*!< [14..15] tbd */

/** TLD7002_OTP_CUST_REG8 masks */
#define TLD7002_OTP_CUST_REG8_CH_TH_DER_EN_MSK							  0x0001U					/*!< [0] Thermal derating Enable */
#define TLD7002_OTP_CUST_REG8_CH_TH_DER_TH_MSK							  0x000EU					/*!< [1..3] Thermal derating TJDER configuration */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_CH_SET_MSK				   	  0x00F0U					/*!< [4..7] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH01_SET_MSK				  0x0300U					/*!< [8..9] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH23_SET_MSK				  0x0C00U					/*!< [10..11] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH89_SET_MSK				  0x3000U					/*!< [12..13] tbd */
#define TLD7002_OTP_CUST_REG8_PWR_OFF_LOAD_TH_CH1011_SET_MSK			  0xC000U					/*!< [14..15] tbd */

/* TLD7002_OTP_CUST_REG9 register */
/** TLD7002_OTP_CUST_REG9
 *
 */
typedef struct {
...
} TLD7002_OTP_CUST_REG9_t;

/** TLD7002_OTP_CUST_REG9 positions */
#define TLD7002_OTP_CUST_REG9_HSLI_T_BITSMPL_POS						      0U					/*!< [0..1] Setup of the sampling time */
#define TLD7002_OTP_CUST_REG9_HSLI_T_SYNC_BREAK_POS						      2U					/*!< [2..3] Setup of the sync break time */
#define TLD7002_OTP_CUST_REG9_HSLI_T_FRAME_DLY_POS						      4U					/*!< [4..6] Setup of the frame delay time */
#define TLD7002_OTP_CUST_REG9_RAMP_EN_POS								      7U					/*!< [7] Led Driver RAMP enable for each channels */
#define TLD7002_OTP_CUST_REG9_RESERVED_POS								      8U					/*!< [8..15] RESERVED */

/** TLD7002_OTP_CUST_REG9 masks */
#define TLD7002_OTP_CUST_REG9_HSLI_T_BITSMPL_MSK						  0x0003U					/*!< [0..1] Setup of the sampling time */
#define TLD7002_OTP_CUST_REG9_HSLI_T_SYNC_BREAK_MSK						  0x000CU					/*!< [2..3] Setup of the sync break time */
#define TLD7002_OTP_CUST_REG9_HSLI_T_FRAME_DLY_MSK						  0x0070U					/*!< [4..6] Setup of the frame delay time */
#define TLD7002_OTP_CUST_REG9_RAMP_EN_MSK								  0x0080U					/*!< [7] Led Driver RAMP enable for each channels */
#define TLD7002_OTP_CUST_REG9_RESERVED_MSK								  0xFF00U					/*!< [8..15] RESERVED */

/* TLD7002_OTP_CUST_REG10 register */
/** TLD7002_OTP_CUST_REG10
 *
 */
typedef struct {
...
} TLD7002_OTP_CUST_REG10_t;

/** TLD7002_OTP_CUST_REG10 positions */
#define TLD7002_OTP_CUST_REG10_VGPIN0_TJSTART_POS						      0U					/*!< [0..4] Low threshold for the Thermal derating */
#define TLD7002_OTP_CUST_REG10_VGPIN0_TJSTOP_POS						      5U					/*!< [5..9] High threshold for the Thermal derating */
#define TLD7002_OTP_CUST_REG10_CH_TH_DER_GPIN_POS						     10U					/*!< [10] Thermal de-rating switch between DTS and GPIN0 */
#define TLD7002_OTP_CUST_REG10_RESERVED_POS								     11U					/*!< [11..15] RESERVED */

/** TLD7002_OTP_CUST_REG10 masks */
#define TLD7002_OTP_CUST_REG10_VGPIN0_TJSTART_MSK						  0x001FU					/*!< [0..4] Low threshold for the Thermal derating */
#define TLD7002_OTP_CUST_REG10_VGPIN0_TJSTOP_MSK						  0x03E0U					/*!< [5..9] High threshold for the Thermal derating */
#define TLD7002_OTP_CUST_REG10_CH_TH_DER_GPIN_MSK						  0x0400U					/*!< [10] Thermal de-rating switch between DTS and GPIN0 */
#define TLD7002_OTP_CUST_REG10_RESERVED_MSK								  0xF800U					/*!< [11..15] RESERVED */

/* TLD7002_OTP_CUST_REG11 register */
/** TLD7002_OTP_CUST_REG11_t
 *
 */
typedef struct {
