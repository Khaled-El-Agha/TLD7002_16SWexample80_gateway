...
uint8 TLD7002_RX_READ_OST_FRAME(TLD7002_NetworkInstance_t* inst, TLD7002_READ_OST_FRAME_t* frm) {
	...
	if(frm->w_read_output_status.frame_header.CRC_REQ_S_ADD.ADDRESS == TLD7002_FRAME_SLAVE_ADDRESS_BROADCAST) {
		...
		if(inst->rcv_function(frm->read_array, TLD7002_LEN_READ_OST_READ)) {								/*< copy received data in frame */
			...
			frm->r_read_output_status.CSB_OUT0 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT0]);
			frm->r_read_output_status.CSB_OUT1 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT1]);
			frm->r_read_output_status.CSB_OUT2 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT2]);
			frm->r_read_output_status.CSB_OUT3 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT3]);
			frm->r_read_output_status.CSB_OUT4 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT4]);
			frm->r_read_output_status.CSB_OUT5 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT5]);
			frm->r_read_output_status.CSB_OUT6 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT6]);
			frm->r_read_output_status.CSB_OUT7 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT7]);
			frm->r_read_output_status.CSB_OUT8 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT8]);
			frm->r_read_output_status.CSB_OUT9 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT9]);
			frm->r_read_output_status.CSB_OUT10 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT10]);
			frm->r_read_output_status.CSB_OUT11 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT11]);
			frm->r_read_output_status.CSB_OUT12 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT12]);
			frm->r_read_output_status.CSB_OUT13 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT13]);
			frm->r_read_output_status.CSB_OUT14 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT14]);
			frm->r_read_output_status.CSB_OUT15 = TLD7002_ConvOutxByteToStruct(frm->read_array[TLD7002_POS_READ_OST_OSB_OUT15]);
 ...
 *
 * @param[in] TLD7002_FRAME_CHANNEL_STATUS_BYTE_t osb_outx. OUTX output status byte element of READ_OST frame as struct
 *
 * @return uint8 OUTX output status byte of READ_OST frame as uint8 representation
 */
/* Implements DD-SWA-237 */
uint8 TLD7002_ConvOutxStructToByte(TLD7002_FRAME_CHANNEL_STATUS_BYTE_t osb_outx) {
	uint8 ret_byte = 0;
 ...
 *
 * @return TLD7002_FRAME_CHANNEL_STATUS_BYTE_t OUTX output status byte element of READ_OST frame as struct
 */
/* Implements DD-SWA-238 */
TLD7002_FRAME_CHANNEL_STATUS_BYTE_t TLD7002_ConvOutxByteToStruct(uint8 osb_outx) {
	TLD7002_FRAME_CHANNEL_STATUS_BYTE_t ret_element;
