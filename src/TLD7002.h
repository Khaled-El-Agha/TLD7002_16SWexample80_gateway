...
/** TLD7002_FRAME_CHANNEL_STATUS_BYTE_t
 *
 */
typedef struct {
...
typedef struct {
	...
	struct {
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT0;				/*!< channel Status Byte for OUT0 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT1;				/*!< channel Status Byte for OUT1 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT2;				/*!< channel Status Byte for OUT2 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT3;				/*!< channel Status Byte for OUT3 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT4;				/*!< channel Status Byte for OUT4 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT5;				/*!< channel Status Byte for OUT5 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT6;				/*!< channel Status Byte for OUT6 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT7;				/*!< channel Status Byte for OUT7 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT8;				/*!< channel Status Byte for OUT8 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT9;				/*!< channel Status Byte for OUT9 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT10;				/*!< channel Status Byte for OUT10 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT11;				/*!< channel Status Byte for OUT11 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT12;				/*!< channel Status Byte for OUT12 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT13;				/*!< channel Status Byte for OUT13 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT14;				/*!< channel Status Byte for OUT14 */
		TLD7002_FRAME_CHANNEL_STATUS_BYTE_t CSB_OUT15;				/*!< channel Status Byte for OUT15 */
		uint8 SAFETY_BYTE;												/*!< CRC */
		TLD7002_FRAME_TERMINATION_t frame_termination;					/*!< Output status byte and Acknowledge byte */
